...
IF (EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES  WHERE TABLE_SCHEMA = 'com' AND  TABLE_NAME = 'BoletaVisita'))
BEGIN
    DROP TABLE com.BoletaVisita;
END
GO

CREATE TABLE com.BoletaVisita
(
Id INT NOT NULL PRIMARY KEY IDENTITY(1,1),
BoletaId INT NOT NULL REFERENCES com.Boleta(Id),
Visita INT NOT NULL REFERENCES com.Visita(Id)
);
GO